...
<section style="padding:90px 0;">
 ...
 <div style="display:flex; align-items:flex-start; gap:20px; flex-wrap:wrap;">
 <div style="width:60px; height:60px; background:linear-gradient(135deg,#764ba2,#667eea); border-radius:14px; display:flex; align-items:center; justify-content:center; font-size:1.8rem; flex-shrink:0;"></div>
 <div style="flex:1; min-width:240px;">
...
<section style="padding:80px 0; background:#f7fafc;">
 ...
 <span class="met-section-badge" style="background:#e9d5ff; color:#6b21a8;"> Le syst&egrave;me complet</span>
