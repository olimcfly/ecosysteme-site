...
<section style="padding:80px 0; background:#f7fafc;">
 ...
 <span class="lic-section-badge" style="background:#e9d5ff; color:#6b21a8;"> Le fonctionnement</span>
...
<section style="padding:60px 0; background:#f7fafc;">
 ...
 <h3 style="font-size:1.3rem; color:#1a202c; margin-bottom:18px;"> Villes d&eacute;j&agrave; r&eacute;serv&eacute;es</h3>
