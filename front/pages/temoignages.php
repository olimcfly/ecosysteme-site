<?php
$pageTitle = "T&eacute;moignages &mdash; Ce que disent les professionnels qui utilisent ÉCOSYSTÈME IMMO LOCAL+";
...
$temoignages = [
 ...
 'texte' => 'J\'avais d&eacute;j&agrave; essay&eacute; plusieurs outils marketing. Le probl&egrave;me n\'&eacute;tait pas l\'outil&hellip; c\'&eacute;tait que je ne savais pas quoi en faire. Avec ÉCOSYSTÈME IMMO LOCAL+, j\'ai compris comment structurer mon marketing&nbsp;: Persona &rarr; Contenu &rarr; Trafic. L\'assistant IA m\'aide &agrave; cr&eacute;er les bons contenus pour ma zone.',
 'note' => 5,
 'couleur' => '#764ba2',
 'tag' => 'Membre Fondateur',
 ],
...
<section style="padding:90px 0 70px; text-align:center; background:linear-gradient(135deg,#667eea 0%,#764ba2 100%);">
 ...
 Membres fondateurs actifs &mdash; retours r&eacute;els
 </div>
 <h1 style="font-size:2.6rem; font-weight:800; line-height:1.2; color:white; margin-bottom:18px;">
 Ce que disent les professionnels qui utilisent ÉCOSYSTÈME IMMO LOCAL+
 </h1>
...
<section style="padding:80px 0;">
 ...
 <h2 style="font-size:2rem; color:#1a202c; margin-bottom:12px;">Retours de nos partenaires fondateurs</h2>
...
<section style="padding:80px 0; background:#f7fafc;">
 ...
 Les professionnels qui utilisent ÉCOSYSTÈME IMMO LOCAL+ constatent g&eacute;n&eacute;ralement&nbsp;:
 </p>
 </div>
 ...
 ['', '&Eacute;cosyst&egrave;me complet', 'Tous les outils connect&eacute;s'],
 ['', 'Exclusivit&eacute; territoriale', '1 licence par zone'],
 ];
 foreach ($why as $w):
 ?>
...
<section style="padding:70px 0;">
 ...
 Les professionnels retenus b&eacute;n&eacute;ficient d'un acc&egrave;s anticip&eacute; et d'un tarif fondateur durable, selon la disponibilit&eacute; de leur zone.
 </p>
 ...
 Places limit&eacute;es &mdash; acc&egrave;s fondateur
 </div>
 <br>
...
<section style="padding:80px 0; background:linear-gradient(135deg,#667eea 0%,#764ba2 100%); color:white; text-align:center;">
 ...
 Chaque zone ne peut &ecirc;tre attribu&eacute;e qu'&agrave; un seul partenaire ÉCOSYSTÈME IMMO LOCAL+.<br>
