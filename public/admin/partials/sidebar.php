<aside class="admin-sidebar">
    <button id="mobile-menu-toggle" class="btn btn-ghost mobile-toggle" type="button">☰ Menu</button>
    <div class="admin-brand">Ecosystème<span>CRM</span></div>
    <p class="small">Tableau de bord unifié</p>

    <nav class="admin-nav" id="admin-nav">
        <button class="nav-item active" type="button" data-tab="leads">Leads</button>
