<?php
/**
 * ÉCOSYSTÈME IMMO LOCAL+ - Pipeline / Entonnoir de vente
...
<head>
    ...
    <title>Pipeline - <?= SITE_NAME ?></title>
...
<body>
    <div class="container app-shell">
        <?php $activePage = 'pipeline'; include __DIR__ . '/../shared/sidebar.php'; ?>

        <main class="main app-content">
            <div class="page-header">
                <h1>Pipeline / Entonnoir de vente</h1>
            </div>
