<?php
/**
 * ÉCOSYSTÈME IMMO LOCAL+ - Tunnels de vente
...
<head>
    ...
    <title>Tunnels de vente - <?= SITE_NAME ?></title>
...
<body>
    <div class="container">
        <?php $activePage = 'tunnels'; include __DIR__ . '/../shared/sidebar.php'; ?>

        <main class="main">
            <div class="page-header">
                <h1>Tunnels de vente</h1>
            </div>
