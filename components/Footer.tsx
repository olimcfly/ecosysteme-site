  ...
  return (
    <footer className="border-t border-[#1A2840]">
      ...
      <div className="border-t border-[#1A2840] py-10 px-4 sm:px-6">
        ...
        <div className="max-w-6xl mx-auto mt-8 pt-6 border-t border-[#1A2840] flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-[#4A5568] text-xs">
            &copy; 2026 Écosystème Immo — SAS OCDM Agency. Tous droits réservés.
          </p>
          <div className="flex gap-5">
            <a href="/mentions-legales" className="text-[#4A5568] hover:text-[#8090A8] text-xs transition-colors">
              Mentions légales
            </a>
            <a href="/confidentialite" className="text-[#4A5568] hover:text-[#8090A8] text-xs transition-colors">
