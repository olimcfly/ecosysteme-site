      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-14">
          ...
          <p className="text-[#8090A8] max-w-xl mx-auto text-sm leading-relaxed">
            Toutes les offres incluent l&apos;exclusivité territoriale. Un seul conseiller par ville — le premier qui réserve.
          </p>
        </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            <div className="flex-1">
              <p className="text-[#C8A84B] text-xs font-semibold uppercase tracking-wide mb-2">
                Option disponible sur tous les plans
              </p>
              <p className="text-[#EEE8D8] font-semibold mb-1">
                Exclusivité verrouillée — 900 € paiement unique
              </p>
              <p className="text-[#8090A8] text-sm leading-relaxed">
                Verrou permanent sur votre territoire. Garantie contractuelle qu&apos;aucun autre conseiller
                ne peut être déployé dans votre ville, même après résiliation de l&apos;abonnement.
              </p>
            </div>
            <a
